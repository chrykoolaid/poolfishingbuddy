...
namespace PoolFishingBuddy
{
    public class PoolFisher : BotBase
    {
        ...
        static public string Localization = Lua.GetReturnVal<string>("if GetLocale() == \"deDE\" then return \"deDE\"; else return \"enGB\"; end", 0);

        #endregion

        #region Overrides of BotBase

        private readonly Version _version = new Version(1, 1, 06);
        ...
        {
            Logging.Write(System.Drawing.Color.DarkCyan, "{0} - Pool Fisher {1} starting! ({2})", Helpers.TimeNow, _version, Localization);
